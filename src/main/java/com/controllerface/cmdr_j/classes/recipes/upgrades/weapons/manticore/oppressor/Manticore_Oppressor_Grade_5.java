...
public class Manticore_Oppressor_Grade_5 extends AbstractUpgradeRecipe
{
    public Manticore_Oppressor_Grade_5()
    {
        super("Manticore Oppressor - Grade 5",
            ItemGrade.GRADE_5,
            new ItemEffects(
                new ItemEffectData(ItemEffect.DamagePerSecond, 16.08d),
