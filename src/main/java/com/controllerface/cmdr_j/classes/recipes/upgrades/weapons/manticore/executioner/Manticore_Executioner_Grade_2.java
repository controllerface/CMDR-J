...
public class Manticore_Executioner_Grade_2 extends AbstractUpgradeRecipe
{
    public Manticore_Executioner_Grade_2()
    {
        super("Manticore Executioner - Grade 2",
            ItemGrade.GRADE_2,
            new ItemEffects(
                new ItemEffectData(ItemEffect.DamagePerSecond, 15.68d),
