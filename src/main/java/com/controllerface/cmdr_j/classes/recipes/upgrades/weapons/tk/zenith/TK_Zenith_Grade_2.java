...
public class TK_Zenith_Grade_2 extends AbstractUpgradeRecipe
{
    public TK_Zenith_Grade_2()
    {
        super("TK Zenith - Grade 2",
            ItemGrade.GRADE_2,
            new ItemEffects(
                new ItemEffectData(ItemEffect.DamagePerSecond, 11.97d),
            ...
            new CostData(CreditCost.CREDIT_COST, 180_000));
    }
}