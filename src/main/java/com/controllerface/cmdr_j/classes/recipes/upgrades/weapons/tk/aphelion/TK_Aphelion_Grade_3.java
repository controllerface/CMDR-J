...
public class TK_Aphelion_Grade_3 extends AbstractUpgradeRecipe
{
    public TK_Aphelion_Grade_3()
    {
        super("TK Aphelion - Grade 3",
            ItemGrade.GRADE_3,
            new ItemEffects(
                new ItemEffectData(ItemEffect.DamagePerSecond, 15.39d),
