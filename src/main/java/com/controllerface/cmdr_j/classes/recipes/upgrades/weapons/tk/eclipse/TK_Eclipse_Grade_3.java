...
public class TK_Eclipse_Grade_3 extends AbstractUpgradeRecipe
{
    public TK_Eclipse_Grade_3()
    {
        super("TK Eclipse - Grade 3",
            ItemGrade.GRADE_3,
            new ItemEffects(
                new ItemEffectData(ItemEffect.DamagePerSecond, 15.0d),
