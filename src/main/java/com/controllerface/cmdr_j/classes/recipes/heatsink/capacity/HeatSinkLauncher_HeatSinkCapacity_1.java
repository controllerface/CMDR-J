package com.controllerface.cmdr_j.classes.recipes.heatsink.capacity;
...
public class HeatSinkLauncher_HeatSinkCapacity_1 extends AbstractModificationRecipe
{
        ...
        super(HeatSinkLauncher_HeatSinkCapacity_1.class.getSimpleName(), ItemGrade.GRADE_1,
                new ItemEffects
                        (
                                ...
                                new ItemEffectData(ItemEffect.ReloadTime_Percent, 50d)
                        ),
