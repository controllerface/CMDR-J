...
public class Guardian_Shard_Cannon_Turreted_Small extends AbstractTechnologyRecipe
{
    public Guardian_Shard_Cannon_Turreted_Small()
    {
        super("Small Guardian Shard Cannon [Turreted]",
            new ItemEffects(
                    new ItemEffectData(ItemEffect.tech_unlock, 0.0)
            ),
            new CostData(Material.GUARDIAN_WEAPONBLUEPRINT, 1),
            new CostData(Material.GUARDIAN_POWERCONDUIT, 15),
