...
public class Guardian_Shard_Cannon_Fixed_Small extends AbstractTechnologyRecipe
{
    public Guardian_Shard_Cannon_Fixed_Small()
    {
        super("Small Guardian Shard Cannon [Fixed]",
            new ItemEffects(
