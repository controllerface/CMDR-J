...
public class Karma_C_44_Grade_2 extends AbstractUpgradeRecipe
{
    public Karma_C_44_Grade_2()
    {
        super("Karma C-44 - Grade 2",
            ItemGrade.GRADE_2,
            new ItemEffects(
                new ItemEffectData(ItemEffect.DamagePerSecond, 11.2d),
