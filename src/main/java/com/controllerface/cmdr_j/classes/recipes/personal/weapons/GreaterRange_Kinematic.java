...
public class GreaterRange_Kinematic extends AbstractModificationRecipe
{
    public GreaterRange_Kinematic()
    {
        super(GreaterRange_Kinematic.class.getSimpleName(), ItemGrade.MicroMaterial,
            new ItemEffects
                (
