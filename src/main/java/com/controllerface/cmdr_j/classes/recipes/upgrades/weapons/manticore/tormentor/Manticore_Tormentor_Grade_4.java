...
public class Manticore_Tormentor_Grade_4 extends AbstractUpgradeRecipe
{
    public Manticore_Tormentor_Grade_4()
    {
        super("Manticore Tormentor - Grade 4",
            ItemGrade.GRADE_4,
            new ItemEffects(
                new ItemEffectData(ItemEffect.DamagePerSecond, 28.9d),
