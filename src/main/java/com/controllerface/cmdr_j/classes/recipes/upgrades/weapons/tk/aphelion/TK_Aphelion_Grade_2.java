...
public class TK_Aphelion_Grade_2 extends AbstractUpgradeRecipe
{
    public TK_Aphelion_Grade_2()
    {
        super("TK Aphelion - Grade 2",
            ItemGrade.GRADE_2,
            new ItemEffects(
                new ItemEffectData(ItemEffect.DamagePerSecond, 11.6d),
