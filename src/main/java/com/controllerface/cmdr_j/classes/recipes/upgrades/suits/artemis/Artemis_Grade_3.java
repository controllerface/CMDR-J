...
public class Artemis_Grade_3 extends AbstractUpgradeRecipe
{
    public Artemis_Grade_3()
    {
        super("Artemis Suit - Grade 3",
            ItemGrade.GRADE_3,
            new ItemEffects(
                new ItemEffectData(ItemEffect.Suit_Shield_Regen, 1.32d),
                new ItemEffectData(ItemEffect.Suit_Shield_Capacity, 18.0d),
            ...
            new CostData(Material.AEROGEL, 15),
