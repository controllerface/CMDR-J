...
public class Guardian_Plasma_Charger_Turreted_Small extends AbstractTechnologyRecipe
{
    public Guardian_Plasma_Charger_Turreted_Small()
    {
        super("Small Guardian Plasma Charger [Turreted]",
            new ItemEffects(
            ...
            new CostData(Material.GUARDIAN_TECHCOMPONENT, 12),
