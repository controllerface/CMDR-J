...
public class FixedAdvancedMultiCannon_Medium extends AbstractMultiCannon
{
    public FixedAdvancedMultiCannon_Medium()
    {
        // todo: update states, from regular version
        super("Medium Fixed Advanced Multi-Cannon",
            new ItemEffects(
