...
public class FixedSeismicChargeLauncher_Medium extends AbstractSeismicChargeLauncher
{
    public FixedSeismicChargeLauncher_Medium()
    {
        super("Medium Fixed Seismic Charge Launcher", 
            new ItemEffects(
