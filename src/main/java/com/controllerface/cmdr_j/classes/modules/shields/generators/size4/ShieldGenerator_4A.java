package com.controllerface.cmdr_j.classes.modules.shields.generators.size4;
...
public class ShieldGenerator_4A extends AbstractShieldGenerator
{
    public ShieldGenerator_4A()
    {
        super("4A Shield Generator",
            new ItemEffects(
                  new ItemEffectData(ItemEffect.Mass, 10.0),
                  new ItemEffectData(ItemEffect.Integrity, 96.0),
                  new ItemEffectData(ItemEffect.PowerDraw, 3.08),
