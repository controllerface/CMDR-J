package com.controllerface.cmdr_j.classes.modules.shields.generators.size6;
...
public class ShieldGenerator_6C_BiWeave extends AbstractShieldGenerator
{
    public ShieldGenerator_6C_BiWeave()
    {
        super("6C Bi-Weave Shield Generator",
            new ItemEffects(
                  ...
                  new ItemEffectData(ItemEffect.RegenRate, 3.2),
                  new ItemEffectData(ItemEffect.BrokenRegenRate, 7.995),
