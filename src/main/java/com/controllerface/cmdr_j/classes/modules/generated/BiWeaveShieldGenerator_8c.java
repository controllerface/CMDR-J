...
public class BiWeaveShieldGenerator_8c extends AbstractModule
{
    public BiWeaveShieldGenerator_8c()
    {
        super("8c Bi-Weave Shield Generator", ModificationType.Shield_Generator, ExperimentalType.Shield_Generator, 
            new ItemEffects(
