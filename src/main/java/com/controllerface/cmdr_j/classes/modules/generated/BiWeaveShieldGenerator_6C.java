...
public class BiWeaveShieldGenerator_6C extends AbstractModule
{
    public BiWeaveShieldGenerator_6C()
    {
        super("6C Bi-Weave Shield Generator", ModificationType.Shield_Generator, ExperimentalType.Shield_Generator, 
            new ItemEffects(
