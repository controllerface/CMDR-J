...
public class LoadoutEvent implements BiConsumer<GameState, Map<String, Object>>
{
    ...
    public void accept(GameState gameState, Map<String, Object> event)
    {
        ...
        JournalEvent.setShipStat(gameState, event, ShipStat.Rebuy);
        JournalEvent.setShipStat(gameState, event, ShipStat.UnladenMass);
        JournalEvent.setShipStat(gameState, event, ShipStat.MaxJumpRange);
        JournalEvent.setShipStat(gameState, event, ShipStat.CargoCapacity);
        ...
        {
            JournalEvent.setShipStat(gameState, event, ShipStat.HullValue);
        }

        if (event.get("ModulesValue") != null)
        {
            JournalEvent.setShipStat(gameState, event, ShipStat.ModulesValue);
        }
    ...
    private void setModule(GameState gameState, Map<String, Object> moduleData)
    {
        ...
        if (engineering != null)
        {
            ...
            var modificationBlueprint = JournalEvent.determineModificationBlueprint(modificationName);
            ...
            var experimentalRecipe = JournalEvent.determineExperimentalRecipe(experimentalEffectName);
