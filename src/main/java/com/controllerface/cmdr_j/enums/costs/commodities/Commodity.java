...
public enum Commodity implements TaskCost
{
    ...
    // Rare Commodities
    APAVIETII(ItemGrade.RareCommodity),
    CETIAEPYORNISEGG(ItemGrade.RareCommodity),
    ...
    CD75CATCOFFEE(ItemGrade.RareCommodity),
    ...
    ANIMALEFFIGIES(ItemGrade.RareCommodity),
    ...
    DURADRIVES(ItemGrade.RareCommodity),
    ELEUTHERMALS(ItemGrade.RareCommodity),
    ERANINPEARLWHISKY(ItemGrade.RareCommodity),
    ...
    GALACTICTRAVELGUIDE(ItemGrade.RareCommodity),
    ...
    HIP41181SQUID(ItemGrade.RareCommodity),
    ...
    KACHIRIGINLEACHES(ItemGrade.RareCommodity),
    ...
    KINAGOINSTRUMENTS(ItemGrade.RareCommodity),
    KONGGAALE(ItemGrade.RareCommodity),
    KORROKUNGPELLETS(ItemGrade.RareCommodity),
    ...
    TRANSGENICONIONHEAD(ItemGrade.RareCommodity),
    ...
    NANOMEDICINES(ItemGrade.RareCommodity),
    ...
    ONIONHEADA(ItemGrade.RareCommodity),
    ONIONHEADB(ItemGrade.RareCommodity),
    OPHIUCHIEXINOARTEFACTS(ItemGrade.RareCommodity),
    ...
    PLATINUMALOY(ItemGrade.Mission), // unavailable
    RAJUKRUSTOVES(ItemGrade.RareCommodity),
    RAPABAOSNAKESKINS(ItemGrade.RareCommodity),
    RUSANIOLDSMOKEY(ItemGrade.RareCommodity),
    SANUMAMEAT(ItemGrade.RareCommodity),
    ...
    TARACHTORSPICE(ItemGrade.RareCommodity),
