...
public enum RankStat implements Statistic
{
    ...
    Rank_Soldier("Soldier", "Soldier Rank"),
    Rank_Exobiologist("Exobiologist", "Exobiologist Rank"),
    ...
    Progress_Soldier("Soldier", "Soldier Rank Progress"),
    Progress_Exobiologist("Exobiologist", "Exobiologist Rank Progress"),
