...
public enum Commodity implements ProcurementCost
{
    ...
    ANCIENTARTEFACT(ItemGrade.Space),
    ...
    EXPERIMENTALCHEMICALS(ItemGrade.Space),
    ...
    PROTOTYPETECH(ItemGrade.Space),
    RAREARTWORK(ItemGrade.Space),
    REBELTRANSMISSIONS(ItemGrade.Space),
    ...
    TECHNICALBLUEPRINTS(ItemGrade.Space),
    ...
    LANDENRICHMENTSYSTEMS(ItemGrade.Space),
