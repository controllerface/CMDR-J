...
public enum ModificationRecipe implements ProcurementRecipe
{
    ...
    Efficient_1(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.SULPHUR, 1)),
    ...
    Efficient_2(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.SULPHUR, 1),
            new MaterialInventoryData(Material.HEATDISPERSIONPLATE, 1)),
    ...
    Efficient_3(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.SCRAMBLEDEMISSIONDATA, 1),
            new MaterialInventoryData(Material.CHROMIUM, 1),
            new MaterialInventoryData(Material.HEATEXCHANGERS, 1)),
    ...
    Efficient_4(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.ARCHIVEDEMISSIONDATA, 1),
            new MaterialInventoryData(Material.SELENIUM, 1),
    ...
    Efficient_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.EMISSIONDATA, 1),
            new MaterialInventoryData(Material.CADMIUM, 1),
            new MaterialInventoryData(Material.PROTOHEATRADIATORS, 1)),
    ...
    Lightweight_Bulkheads_1(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.IRON, 1)),
    ...
    Lightweight_Bulkheads_2(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.IRON, 1),
            new MaterialInventoryData(Material.CONDUCTIVECOMPONENTS, 1)),
    ...
    Lightweight_Bulkheads_3(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.IRON, 1),
            new MaterialInventoryData(Material.CONDUCTIVECOMPONENTS, 1),
            new MaterialInventoryData(Material.HIGHDENSITYCOMPOSITES, 1)),
    ...
    Lightweight_Bulkheads_4(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.GERMANIUM, 1),
            new MaterialInventoryData(Material.CONDUCTIVECERAMICS, 1),
    ...
    Lightweight_Bulkheads_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.MILITARYGRADEALLOYS, 1)),
    ...
    Lightweight_Sensors_1(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.PHOSPHORUS, 1)),
    ...
    Lightweight_Sensors_2(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.SALVAGEDALLOYS, 1),
    ...
    Lightweight_Sensors_4(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.CONDUCTIVECOMPONENTS, 1),
            new MaterialInventoryData(Material.PHASEALLOYS, 1),
    ...
    Lightweight_Sensors_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.CONDUCTIVECERAMICS, 1),
            new MaterialInventoryData(Material.PROTOLIGHTALLOYS, 1),
            new MaterialInventoryData(Material.PROTORADIOLICALLOYS, 1)),
    ...
    Long_Range_Weapon_2(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.SULPHUR, 1),
            new MaterialInventoryData(Material.CONSUMERFIRMWARE, 1)),
    ...
    Long_Range_Weapon_3(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.SULPHUR, 1),
            new MaterialInventoryData(Material.CONSUMERFIRMWARE, 1),
            new MaterialInventoryData(Material.FOCUSCRYSTALS, 1)),
    ...
    Long_Range_Weapon_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.INDUSTRIALFIRMWARE, 1),
            new MaterialInventoryData(Material.THERMICALLOYS, 1),
            new MaterialInventoryData(Material.BIOTECHCONDUCTORS, 1)),
    ...
    Long_Range_Scan_2(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.IRON, 1),
            new MaterialInventoryData(Material.HYBRIDCAPACITORS, 1)),
    ...
    Long_Range_Scan_4(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.GERMANIUM, 1),
            new MaterialInventoryData(Material.ELECTROCHEMICALARRAYS, 1),
    ...
    Long_Range_Scan_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.COMPACTEMISSIONSDATA, 1)),
    ...
    Long_Range_Interdictor_1(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.ENCRYPTEDFILES, 1)),
    ...
    Long_Range_Interdictor_2(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.DISRUPTEDWAKEECHOES, 1),
            new MaterialInventoryData(Material.ENCRYPTIONCODES, 1)),
    ...
    Long_Range_Interdictor_3(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.BULKSCANDATA, 1),
            new MaterialInventoryData(Material.FSDTELEMETRY, 1),
            new MaterialInventoryData(Material.SYMMETRICKEYS, 1)),
    ...
    Long_Range_Interdictor_4(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.SCANARCHIVES, 1),
            new MaterialInventoryData(Material.WAKESOLUTIONS, 1),
            new MaterialInventoryData(Material.ENCRYPTIONARCHIVES, 1)),
    ...
    Long_Range_Interdictor_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.CLASSIFIEDSCANDATA, 1),
    ...
    Overcharged_1(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.NICKEL, 1)),
    ...
    Overcharged_4(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.ZINC, 1),
            new MaterialInventoryData(Material.CONDUCTIVECERAMICS, 1),
            new MaterialInventoryData(Material.POLYMERCAPACITORS, 1)),
    ...
    Overcharged_Power_Plant_2(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.HEATCONDUCTIONWIRING, 1),
            new MaterialInventoryData(Material.CONDUCTIVECOMPONENTS, 1)),
    ...
    Overcharged_Power_Plant_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.CONDUCTIVECERAMICS, 1),
            new MaterialInventoryData(Material.CHEMICALMANIPULATORS, 1),
            new MaterialInventoryData(Material.TELLURIUM, 1)),
    ...
    Sturdy_3(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.NICKEL, 1),
            new MaterialInventoryData(Material.SHIELDEMITTERS, 1),
            new MaterialInventoryData(Material.TUNGSTEN, 1)),
    ...
    Sturdy_4(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.ZINC, 1),
            new MaterialInventoryData(Material.TUNGSTEN, 1),
            new MaterialInventoryData(Material.MOLYBDENUM, 1)),
    ...
    Sturdy_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.HIGHDENSITYCOMPOSITES, 1),
            new MaterialInventoryData(Material.MOLYBDENUM, 1),
            new MaterialInventoryData(Material.TECHNETIUM, 1)),
    ...
    Focused_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.NIOBIUM, 1),
            new MaterialInventoryData(Material.REFINEDFOCUSCRYSTALS, 1),
            new MaterialInventoryData(Material.MILITARYSUPERCAPACITORS, 1)),
    ...
    Rapid_Fire_1(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.MECHANICALSCRAP, 1)),
    ...
    Rapid_Fire_3(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.LEGACYFIRMWARE, 1),
            new MaterialInventoryData(Material.MECHANICALEQUIPMENT, 1),
            new MaterialInventoryData(Material.PRECIPITATEDALLOYS, 1)),
    ...
    Rapid_Fire_4(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.CONSUMERFIRMWARE, 1),
            new MaterialInventoryData(Material.MECHANICALCOMPONENTS, 1),
            new MaterialInventoryData(Material.THERMICALLOYS, 1)),
    ...
    Double_Shot_1(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.CARBON, 1)),
    ...
    Reinforced_Thrusters_3(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.HEATCONDUCTIONWIRING, 1),
            new MaterialInventoryData(Material.VANADIUM, 1),
            new MaterialInventoryData(Material.SHIELDINGSENSORS, 1)),
    ...
    Reinforced_Thrusters_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.HEATEXCHANGERS, 1),
            new MaterialInventoryData(Material.FEDPROPRIETARYCOMPOSITES, 1),
            new MaterialInventoryData(Material.IMPERIALSHIELDING, 1)),
    ...
    Reinforced_Shield_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.ARSENIC, 1),
            new MaterialInventoryData(Material.CONDUCTIVEPOLYMERS, 1),
            new MaterialInventoryData(Material.IMPROVISEDCOMPONENTS, 1)),
    ...
    Shielded_1(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.WORNSHIELDEMITTERS, 1)),
    ...
    Shielded_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.TUNGSTEN, 1),
            new MaterialInventoryData(Material.COMPOUNDSHIELDING, 1),
            new MaterialInventoryData(Material.FEDCORECOMPOSITES, 1)),
    ...
    Fast_Scan_2(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.PHOSPHORUS, 1),
            new MaterialInventoryData(Material.UNCUTFOCUSCRYSTALS, 1)),
    ...
    Wide_Angle_4(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.MECHANICALEQUIPMENT, 1),
            new MaterialInventoryData(Material.NIOBIUM, 1),
            new MaterialInventoryData(Material.ENCODEDSCANDATA, 1)),
    ...
    Blast_Resistant_Hull_4(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.GALVANISINGALLOYS, 1),
            new MaterialInventoryData(Material.TUNGSTEN, 1),
            new MaterialInventoryData(Material.MERCURY, 1)),
    ...
    Blast_Resistant_Shield_Booster_4(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.GERMANIUM, 1),
            new MaterialInventoryData(Material.SHIELDDENSITYREPORTS, 1),
            new MaterialInventoryData(Material.REFINEDFOCUSCRYSTALS, 1)),
    ...
    Blast_Resistant_Shield_Booster_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.EXQUISITEFOCUSCRYSTALS, 1)),
    ...
    Heavy_Duty_Shield_Booster_1(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.GRIDRESISTORS, 1)),
    ...
    Heavy_Duty_Shield_Booster_2(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.SHIELDCYCLERECORDINGS, 1),
            new MaterialInventoryData(Material.HYBRIDCAPACITORS, 1)),
    ...
    Heavy_Duty_Shield_Booster_4(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.SHIELDSOAKANALYSIS, 1),
            new MaterialInventoryData(Material.ELECTROCHEMICALARRAYS, 1),
            new MaterialInventoryData(Material.TIN, 1)),
    ...
    Heavy_Duty_Shield_Booster_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.SHIELDDENSITYREPORTS, 1),
            new MaterialInventoryData(Material.POLYMERCAPACITORS, 1),
            new MaterialInventoryData(Material.ANTIMONY, 1)),
    ...
    Increased_Range_2(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.DISRUPTEDWAKEECHOES, 1),
            new MaterialInventoryData(Material.CHEMICALPROCESSORS, 1)),
    ...
    Increased_Range_4(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.MANGANESE, 1),
            new MaterialInventoryData(Material.CHEMICALDISTILLERY, 1),
            new MaterialInventoryData(Material.HYPERSPACETRAJECTORIES, 1)),
    ...
    Increased_Range_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.ARSENIC, 1),
            new MaterialInventoryData(Material.CHEMICALMANIPULATORS, 1),
            new MaterialInventoryData(Material.DATAMINEDWAKE, 1)),
    ...
    Engine_Focused_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.SCANDATABANKS, 1),
            new MaterialInventoryData(Material.CADMIUM, 1),
            new MaterialInventoryData(Material.MILITARYSUPERCAPACITORS, 1)),
    ...
    Dirty_5(new ModificationEffectData
            ...
            new MaterialInventoryData(Material.INDUSTRIALFIRMWARE, 1),
            new MaterialInventoryData(Material.CADMIUM, 1),
            new MaterialInventoryData(Material.PHARMACEUTICALISOLATORS, 1));

    private final MaterialInventoryData[] cost;
    private final ModificationEffectData effects;

    ModificationRecipe(ModificationEffectData effects, MaterialInventoryData... cost)
    {
